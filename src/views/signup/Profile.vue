<template>
    <div class="bg-primary-200 flex flex-col items-center justify-around" style="height:100vh">

        <div class="flex flex-col items-center w-full">   
            <img src="@/assets/img/onboarding-profile-person.svg" style="width:40%" alt="Darcy Logo" />
        ...
        <div class="flex flex-row w-full md:w-1/2">
            ...
            <div class="w-full">
                ...
                <label for="publicCheck"><input id="publicCheck" type="checkbox" v-model="isPublic"> Public</label>
            </div>
        </div>

        <button @click="saveSettings()" class="btn btn-primary">Save & finish</button>  
    ...
    methods:{
        saveSettings(){
            if(this.name.length){
                ...
                this.ibex.saveSettings(settings)
                .then(res=>{
                    console.log(res);
